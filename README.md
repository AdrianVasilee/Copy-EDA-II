...
This project is a copy of a work done by two university collegues and myself. It's an extensive project which showcases the application of multiple algorithms. I should mention that the template comes from our Structure of algorithms course at our university Pompeu Fabra.
